...
namespace RT::OMP
{
    ...
    struct Light
    {
        ...
        template<bool EnablePrimaryRayIntrinsics>
        inline std::vector<RayType> SpawnSecondaryRays(
            const RT::OMP::Ray<EnablePrimaryRayIntrinsics>& primaryRay,
            RT::float_t intersectionDistance ) const
        {
