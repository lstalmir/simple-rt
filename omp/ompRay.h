...
namespace RT::OMP
{
    ...
    struct alignas(32) Ray
    {
        ...
        template<bool EnablePlaneIntrinsics>
        inline vec4 Intersect( const Plane<EnablePlaneIntrinsics> & plane ) const
        {
        ...
        template<bool EnableTriangleIntrinsics>
        inline vec4 Intersect( const Triangle<EnableTriangleIntrinsics> & triangle ) const
        {
        ...
        template<bool EnableBoxIntrinsics>
        inline bool Intersect( const Box<EnableBoxIntrinsics> & box ) const
        {
            if constexpr( EnableIntrinsics )
            {
        ...
        template<bool EnablePlaneIntrinsics>
        inline Ray Reflect( const Plane<EnablePlaneIntrinsics> & plane, const vec4 & intersectionPoint ) const
        {
